...
<div class="container">
    ...
    <div class="card info-box">
        <p style="font-size:.86em;color:#90caf9">
            ...
            проверяет текущих друзей и входящие заявки, после чего по очереди
            <em>отправляет</em> или <em>принимает</em> заявку в друзья каждому из остальных
            аккаунтов. После одного прогона все аккаунты становятся друзьями.
            <br>
