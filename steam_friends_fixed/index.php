...
<div class="container">
    ...
    <div class="card info-box">
        <p style="font-size:.86em;color:#90caf9">
            <strong>Как это работает:</strong> Для каждого аккаунта-источника система
            логинится через Steam, на каждой паре с другим аккаунтом создаёт у себя
            одноразовую <em>quick-invite ссылку</em>, и второй аккаунт переходит по ней
            под своими cookies — Steam регистрирует обоюдную дружбу серверно. Сама
            ссылка нигде не выводится — ни на странице, ни в логах.
            <br>
